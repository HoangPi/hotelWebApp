                                ...
                                <div class="form-group">
                                    ...
                                    <label for="id_label_single" style="width: 100%;">
                                        <select class="js-example-basic-single js-states form-control" id="id_label_single" style="width: 100%;">
                                            <option value="Australia" onclick='displayInfo("assets/images/type7.png");'>test</option>
                                            <option value="Australia" onclick='displayInfo("assets/images/type4.png");'>test1</option>
...
<script>
    ...
    {
        document.getElementById("displayImage").src = a.src.replace("_t", "_b");
    }
</script>
