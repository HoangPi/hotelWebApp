...
<%--      <input type="text" class="form-control" id="userName" name="userName" placeholder="${userName}" readonly>--%>
      ...
      <label for="pass1" class="sr-only sr-only-focusable">User name</label>
      <input type="password" class="form-control" id="pass1" name="pass1" placeholder="New Password">

      <label for="pass2" class="sr-only sr-only-focusable">User name</label>
      <input type="password" class="form-control" id="pass2" name="pass2" placeholder="Retype Password">

      <label for="code" class="sr-only sr-only-focusable">User name</label>
      <input type="text" class="form-control" id="code" name="code" placeholder="PIN">
    </div>
    <div>
